...
function render_featured_sim() {
	...
	if ($len && $seed) {
		...
		$command = "./simulator single-json --length ".escapeshellarg($len)." --seed ".escapeshellarg($seed)." player ".escapeshellarg($sim['subject-file'])." ".escapeshellarg($sim['rotation-file']);
